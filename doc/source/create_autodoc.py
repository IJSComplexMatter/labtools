...
This is a labtools package API. It was automatically generated from package source files.
A detailed function definition along with some usage examples are provided.
