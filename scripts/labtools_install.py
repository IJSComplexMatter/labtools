...
def install(shortcuts, remove, prefix=None):
    ...
    if sys.platform == 'linux2':
        from appinst.linux2 import Menu, ShortCut

    elif sys.platform == 'darwin':
        from appinst.darwin import Menu, ShortCut

    elif sys.platform == 'win32':
        from appinst.win32 import Menu, ShortCut
